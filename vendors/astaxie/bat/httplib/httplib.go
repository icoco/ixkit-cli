...
//@ we want keep the exist body then need merge it here
func (b *BeegoHttpRequest) mergeBody(obj interface{}) interface{} {
	if b.req.Body == nil {
		return obj
	}
	var body map[string]interface{}
	if error := json.NewDecoder(b.req.Body).Decode(&body); error != nil {
		return obj
	}
	//@step
	...
	pbody := ioutil.NopCloser(buf)
	//@step
	var data map[string]interface{}
	if error := json.NewDecoder(pbody).Decode(&data); error != nil {
		return obj
	}
	for k, v := range data {
		body[k] = v
...
//@@
func (b *BeegoHttpRequest) Body2Map() map[string]interface{} {
	if b.req.Body == nil {
		return nil
	}
	var body map[string]interface{}
